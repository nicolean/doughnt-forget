...
export default function ModalContainer({ isOpen, setIsOpen, title, children, showCancel, onCtaClick, ctaText }: ModalContainerProps) {
  ...
  return (
    isOpen ?
      <div className="fixed flex sm:items-center justify-center top-0 left-0 w-screen h-screen sm:p-10 bg-gray-900/50 z-10">
        <div ref={wrapperRef} className="flex flex-col rounded shadow bg-white w-screen sm:w-9/12 lg:w-6/12 xl:w-4/12 h-[100dvh] sm:max-h-full sm:h-auto">
